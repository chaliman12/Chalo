  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b>Smart-Placement</b></a>
            <!--logo end-->
            <div class="top-menu">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <ul class="left-links">
                      <li><a  href="blank.php"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Check Student Status</a></li>
                      <li><a  href="attendant.php"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Add new University</a></li>
                      <li><a  href="basic_table.php"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Insert Ranking</a></li>
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: 'Welcome to smart-placement!',
            // (string | mandatory) the text inside the notification
            text: 'Makes your placement easier.'
