...
<?php
$sel="SELECT `requests`.`id`, `location`, `annual_temp`, `distance`, `ranking`, `speciality`, `status`,`university_name` FROM `requests`,`rarking` WHERE `parking`.`id`=`requests`.`parking_id`";
